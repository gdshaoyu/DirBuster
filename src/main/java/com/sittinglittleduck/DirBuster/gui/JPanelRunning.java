...
public class JPanelRunning extends javax.swing.JPanel implements ClipboardOwner
{
    ...
    private void initComponents() {
        ...
        jMenuItemOpen.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/internet-web-browser.png")); // NOI18N
        ...
        jMenuItemCopy.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/edit-copy.png")); // NOI18N
        ...
        jMenuItemSkip.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/media-seek-forward.png")); // NOI18N
        ...
        jMenuItemOpenInBrowser.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/internet-web-browser.png")); // NOI18N
        ...
        jMenuItemCopyURL.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/edit-copy.png")); // NOI18N
        ...
        jButtonBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/go-previous.png")); // NOI18N
        ...
        jButtonStop.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/media-playback-stop.png")); // NOI18N
        ...
        jButtonReport.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/txt.png")); // NOI18N
        ...
        jToggleButtonPause.setIcon(new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/media-playback-pause.png")); // NOI18N
        ...
        jTabbedPaneViewResults.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jTableResults.addMouseListener(new java.awt.event.MouseAdapter()
            ...
            jTabbedPaneViewResults.addTab("Errors: 0", new javax.swing.ImageIcon(getClass().getResource("./").getPath()+"icons/dialog-warning.png"), jScrollPaneErrorView); // NOI18N
            ...
            layout.setHorizontalGroup(
                ...
                .add(layout.createSequentialGroup()
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        ...
                        .add(layout.createSequentialGroup()
                            .addContainerGap()
                            .add(jTabbedPaneViewResults, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 729, Short.MAX_VALUE)))
                    .addContainerGap())
            );
